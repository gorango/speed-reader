<template lang="pug">
article.hor.mx-auto.max-width-2.block.relative
  p(
...
export default {
  props: [ 'moduleName' ],
  computed: {
    blocks () { return this.$store.state[this.moduleName] && this.$store.state[this.moduleName].blocks },
    ...
    word () { return this.$store.state[this.moduleName] && this.$store.state[this.moduleName].word }
  },
  watch: {
    word (_, token) {
